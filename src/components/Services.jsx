        ...
        {ServiceCard.map((card) => {
          return (
            <motion.div
              ...
              whileInView={"animate"}
              key={card.id}
              className="space-y-4 border-[1px] border-black/30 p-6 shadow-[7px_7px_0px_0px_#6c6c6c] hover:bg-black hover:text-white hover:shadow-[7px_7px_0px_0px_#6c6c6c] duration-300 "
            >
